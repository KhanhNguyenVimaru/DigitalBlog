<footer class="bg-white border-t border-gray-200 mt-auto">
    <div class="max-w-7xl mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div class="flex gap-6 mb-2 md:mb-0">
            ...
            <a href="#" class="text-gray-600 hover:text-blue-600 text-sm font-semibold">Community</a>
        ...
        <div class="flex gap-4">
            <a href="#" class="text-gray-400 hover:text-blue-600" title="Twitter">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M22.46 6c-.77.35-1.6.59-2.47.7a4.3 4.3 0 001.88-2.37 8.59 8.59 0 01-2.72 1.04A4.28 4.28 0 0016.11 4c-2.37 0-4.29 1.92-4.29 4.29 0 .34.04.67.1.99C7.69 9.13 4.07 7.38 1.64 4.7c-.37.64-.58 1.38-.58 2.17 0 1.5.76 2.82 1.92 3.6-.7-.02-1.36-.21-1.94-.53v.05c0 2.1 1.5 3.85 3.5 4.25-.36.1-.74.16-1.13.16-.28 0-.54-.03-.8-.08.54 1.7 2.1 2.94 3.95 2.97A8.6 8.6 0 012 19.54c-.29 0-.57-.02-.85-.05A12.13 12.13 0 007.29 21.5c7.55 0 11.68-6.26 11.68-11.68 0-.18-.01-.36-.02-.54A8.18 8.18 0 0024 4.59a8.36 8.36 0 01-2.54.7z"/></svg>
            </a>
            <a href="https://www.facebook.com/nguyen.khanh.201930" class="text-gray-400 hover:text-blue-600" title="Facebook">
            ...
            <a href="https://github.com/KhanhNguyenVimaru" class="text-gray-400 hover:text-blue-600" title="GitHub">
    ...
    <div class="text-center text-xs text-gray-400 py-2 border-t border-gray-100 mt-4">&copy; {{ date('Y') }} DIGITAL BLOG. All rights reserved.</div>
</footer>
